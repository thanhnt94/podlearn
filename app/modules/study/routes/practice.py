...
def sentence_practice(sentence_id, mode=None):
    ...
    template_map = {
        'mastery_grammar': 'study/practice_grammar.html',
        'mastery_vocab': 'study/practice_vocab.html',
        'mastery_sentence': 'study/practice_sentence.html'
    }
    ...
    template_name = template_map.get(sentence.sentence_set.set_type, 'study/practice_sentence.html')
...
def mastery_view(sentence_id):
    ...
    return render_template('study/mastery_view.html', sentence=sentence)
