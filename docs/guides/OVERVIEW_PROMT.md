...
Nhiệm vụ: Hãy đọc nội dung bài (transcript/SRT) dưới đây và viết một đoạn tổng quan tóm tắt nội dung chính dưới dạng "Dàn ý học tập" (Study Guide).
...
[DÁN NỘI DUNG SRT/TRANSCRIPT CỦA BẠN VÀO ĐÂY]

------------------------------------------------------------------------------------------------------

Vai trò: Bạn là một chuyên gia ngôn ngữ học tiếng Nhật kiêm biên tập viên giáo trình học thuật.

Nhiệm vụ: Dựa vào nội dung bài (transcript/SRT) được cung cấp, hãy trích xuất TOÀN BỘ các cấu trúc ngữ pháp quan trọng được sử dụng trong bài.
...
2. Nội dung mỗi mục bắt buộc bao gồm:
   - ### [Số thứ tự]. Cấu trúc: [Tên ngữ pháp]
...
Dưới đây là nội dung bài cần trích xuất:
[DÁN NỘI DUNG SRT/TRANSCRIPT CỦA BẠN VÀO ĐÂY]

------------------------------------------------------------------------------------------------------
Vai trò: Bạn là một chuyên gia ngôn ngữ học tiếng Nhật kiêm biên tập viên giáo trình học thuật.

Nhiệm vụ: Dựa vào nội dung bài (transcript/SRT) được cung cấp, hãy trích xuất các cụm từ đi liền nhau (Collocations - ví dụ: cụm Động từ + Danh từ, cụm Tính từ + Danh từ, Quán dụng ngữ) xuất hiện trong bài.
...
2. Nội dung mỗi mục bắt buộc bao gồm:
   - ### [Số thứ tự]. Cụm từ: [Cụm từ tiếng Nhật]
...
Nhiệm vụ: Dựa vào nội dung bài (transcript/SRT) được cung cấp, hãy trích xuất các TRẠNG TỪ (Adverbs/Phó từ) quan trọng. Ưu tiên các trạng từ chỉ mức độ, cách thức, trạng thái hoặc thái độ người nói.
...
2. Nội dung mỗi mục bắt buộc bao gồm:
   - ### [Số thứ tự]. Trạng từ: [Trạng từ tiếng Nhật] + [Động từ/Tính từ mà nó bổ nghĩa]
