...
export const AISettings: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      await axios.post('/api/admin/settings/gemini', { 
  ...
  const refreshModels = async () => {
    setRefreshing(true);
    try {
      const response = await axios.get('/api/admin/settings/gemini/models');
      if (response.data.success) setModels(response.data.models);
    } catch (err) {
